...
class AdvertisesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advertise" do
    assert_difference('Advertise.count') do
      post advertises_url, params: { advertise: { image_urls: @advertise.image_urls, text: @advertise.text } }
    end
  ...
  test "should update advertise" do
    patch advertise_url(@advertise), params: { advertise: { image_urls: @advertise.image_urls, text: @advertise.text } }
